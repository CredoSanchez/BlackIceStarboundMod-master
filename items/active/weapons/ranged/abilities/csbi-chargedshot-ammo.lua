...
CSBIChargedShotAmmo = WeaponAbility:new()

function CSBIChargedShotAmmo:init()
...
function CSBIChargedShotAmmo:update(dt, fireMode, shiftHeld)
...
function CSBIChargedShotAmmo:charge()
...
function CSBIChargedShotAmmo:fire()
...
function CSBIChargedShotAmmo:fireProjectile(projectileType, projectileParams, inaccuracy, firePosition, projectileCount)
...
function CSBIChargedShotAmmo:reload()
...
function CSBIChargedShotAmmo:reloadTwirl()
...
function CSBIChargedShotAmmo:muzzleFlash()
...
function CSBIChargedShotAmmo:cooldown()
...
function CSBIChargedShotAmmo:firePosition()
  return vec2.add(mcontroller.position(), activeItem.handPosition(self.weapon.muzzleOffset))
end

function CSBIChargedShotAmmo:aimVector(inaccuracy, shotNumber)
...
function CSBIChargedShotAmmo:uninit()
  self:reset()
end
